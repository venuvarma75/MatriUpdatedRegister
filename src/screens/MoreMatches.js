...
//                 <Text>Loading more matches...</Text>
//             </View>
//         );
//     }
...
//             <Text style={styles.title}>More Matches For You</Text>
...
//                     <View style={styles.center}>
//                         <Text style={styles.noMatches}>No more matches found</Text>
//                     </View>
//                 )}
//             </ScrollView>
//         </View>
...
const MoreMatches = ({ user, registeredUsers, navigation }) => {
    ...
    useEffect(() => {
        const loadProfiles = async () => {
            try {
                ...
                // Filter profiles for more matches
