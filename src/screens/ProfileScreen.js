...
const ViewProfile = ({ navigation, user, route }) => {
  // Use user from props or route params
  const profileData = user || route.params?.user || {};
  ...
  const handleShareProfile = async () => {
    try {
      await Share.share({
        message: `Check out ${profileData.firstName}'s profile on our matrimony app!`,
        url: 'https://your-app-domain.com', // Replace with your app link
        title: `${profileData.firstName}'s Profile`
      });
    } catch (error) {
        ...
        {fields.map(field => {
          ...
          return (
            <View key={field} style={styles.row}>
              <Text style={styles.label}>{fieldConfig[field] || field}:</Text>
  ...
  const fieldGroups = [
    {
      ...
      fields: ['firstName', 'lastName', 'age', 'gender', 'profileFor']
    },
    {
      title: "Religion & Community",
      fields: ['religion', 'caste', 'subCaste', 'motherTongue']
    },
    {
      title: "Location",
      fields: ['country', 'city']
    ...
    {
      title: "Marital Status & Physical",
      fields: ['maritalStatus', 'noOfChildren', 'height']
    },
    {
      title: "Education",
      fields: ['highestEducation', 'collegeName']
    },
    {
      title: "Career",
      fields: ['sector', 'occupation', 'companyName', 'annualIncome', 'workLocation']
    },
    {
      title: "Contact Information",
      fields: ['emailId', 'mobileNumber']
    },
    {
      title: "Additional Information",
      fields: ['aboutMe', 'hobbies', 'familyBackground', 'expectations']
    }
  ];
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileHeader}>
          ...
          <View style={styles.profileInfo}>
            ...
            <Text style={styles.profileAge}>
              {profileData.age} years • {profileData.gender}
            </Text>
            <Text style={styles.profileLocation}>
              {profileData.city}, {profileData.country}
            </Text>
            <Text style={styles.profileOccupation}>
              {profileData.occupation} • {profileData.companyName}
            </Text>
          </View>
        </View>
        ...
        {fieldGroups.map((group, index) => 
          renderSection(group.title, group.fields)
        )}
        ...
        <View style={styles.actionSection}>
          ...
          <TouchableOpacity 
            ...
            onPress={handleShareProfile}
          >
            <Icon name="share" size={16} color="#695019" />
