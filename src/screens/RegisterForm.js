            ...
            <View style={[
              ...
              <View style={styles.contentContainer}>
                ...
                <View style={[
                  ...
                  <TextInput
                    style={[
                      ...
                      isSmallDevice && styles.smallTextInput,
                      isTablet && styles.tabletTextInput,
                      formData.email && !isValidEmail(formData.email) && styles.invalidInput
                    ]}
                ...
                <View style={[
                  ...
                  <TextInput
                    style={[
                      ...
                      isSmallDevice && styles.smallTextInput,
                      isTablet && styles.tabletTextInput,
                      formData.mobileNumber && formData.mobileNumber.length !== 10 && styles.invalidInput
                    ]}
                    placeholder="Enter your mobile number"
                    placeholderTextColor="#bcbcbc"
                    value={formData.mobileNumber}
                ...
                <View style={[
                  ...
                  <TextInput
                    style={[
                      ...
                      isSmallDevice && styles.smallTextInput,
                      isTablet && styles.tabletTextInput,
                      formData.password && formData.password.length < 6 && styles.invalidInput
                    ]}
                ...
                <View style={[
                  ...
                  <TextInput
                    style={[
                      ...
                      isSmallDevice && styles.smallTextInput,
                      isTablet && styles.tabletTextInput,
                      formData.confirmPassword && formData.password !== formData.confirmPassword && styles.invalidInput
                    ]}
                ...
                <TouchableOpacity 
                  style={[
                    styles.registerButton,
                    (!formData.fullName || !formData.email || !formData.mobileNumber || !formData.password || !formData.confirmPassword || 
                     !isValidEmail(formData.email) || formData.mobileNumber.length !== 10 || formData.password.length < 6 || 
                     formData.password !== formData.confirmPassword) && styles.registerButtonDisabled,
                    isSmallDevice && styles.smallRegisterButton,
                    isTablet && styles.tabletRegisterButton
                  ]} 
                  onPress={handleRegisterNow}
                  disabled={!formData.fullName || !formData.email || !formData.mobileNumber || !formData.password || !formData.confirmPassword || 
                           !isValidEmail(formData.email) || formData.mobileNumber.length !== 10 || formData.password.length < 6 || 
